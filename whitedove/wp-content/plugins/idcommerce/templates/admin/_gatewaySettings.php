				...
				<div class="postbox">
					...
					<div class="inside">
						<form method="POST" action="" id="gateway-settings" name="gateway-settings">
							...
							<?php //removing coinbase integration because of depreciated SDK ?>
				            ...
				            <div class="columns" style="width: 29%; padding-left: 2.5%; margin-left: 2.5%; margin-top: 40px; border-left: 1px solid #C8D3DC;">
								...
								<div class="form-input inline">
									<input type="checkbox" name="enablelemonway" id="enablelemonway" value="1" class="cc-gateway-chkbox" <?php echo (isset($enablelemonway) && $enablelemonway ? 'checked="checked"' : ''); ?>/>
									<label for="enablelemonway"><?php _e('Enable LemonWay', 'memberdeck'); ?></label>
								</div>
								<?php do_action('idc_other_gateways_after'); ?>
							</div>
							<?php } ?>
			...
			<div class="meta-box-sortables" style="min-height:0;">
				<div class="postbox info">
					...
					<div class="inside">
						...
						<p><?php _e('To use subscriptions, please enable Stripe, Paypal or Authorize.Net.', 'memberdeck'); ?></p>
						...
						<?php } ?>
						<?php 
						// Removing information on Coinbase integration
