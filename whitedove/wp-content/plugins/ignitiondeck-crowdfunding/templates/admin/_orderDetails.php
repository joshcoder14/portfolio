...
?>
<div class="wrap">
	<h2><a class="button add-new-h2" href="admin.php?page=add_order"><?php _e('Add Order', 'ignitiondeck'); ?></a> <?php echo (isset($message) ? $message : '');?></h2>
	...
	<table class="wp-list-table widefat fixed posts idOrders">
		<thead>
			<tr>
				...
				<th scope="col" id="name" class="manage-column sortable desc"><a href="?page=order_details&amp;orderby=name&amp;sort=<?php echo $name_sort; ?><?php echo (isset($_GET['s']) ? '&amp;s='.$_GET['s'] : ""); ?><?php echo (isset($_GET['project']) ? '&amp;project='.$_GET['project'] : ""); ?><?php echo (isset($_GET['order_page']) ? '&amp;order_page='.$_GET['order_page'] : ""); ?>"><b><?php _e('Name', 'ignitiondeck'); ?></b></a></th>
				<th scope="col" id="project" class="manage-column sortable desc"><a href="?page=order_details&amp;orderby=project&amp;sort=<?php echo $project_sort; ?><?php echo (isset($_GET['s']) ? '&amp;s='.$_GET['s'] : ""); ?><?php echo (isset($_GET['project']) ? '&amp;project='.$_GET['project'] : ""); ?><?php echo (isset($_GET['order_page']) ? '&amp;order_page='.$_GET['order_page'] : ""); ?>"><b><?php _e('Project Name', 'ignitiondeck'); ?></b></a></th>
				<th scope="col" id="level" class="manage-column sortable desc"><a href="?page=order_details&amp;orderby=level&amp;sort=<?php echo $level_sort; ?><?php echo (isset($_GET['s']) ? '&amp;s='.$_GET['s'] : ""); ?><?php echo (isset($_GET['project']) ? '&amp;project='.$_GET['project'] : ""); ?><?php echo (isset($_GET['order_page']) ? '&amp;order_page='.$_GET['order_page'] : ""); ?>"><b><?php _e('Level Name', 'ignitiondeck'); ?></b></a></th>
				<th scope="col" id="pledged" class="manage-column sortable desc"><a href="?page=order_details&amp;orderby=pledged&amp;sort=<?php echo $pledged_sort; ?><?php echo (isset($_GET['s']) ? '&amp;s='.$_GET['s'] : ""); ?><?php echo (isset($_GET['project']) ? '&amp;project='.$_GET['project'] : ""); ?><?php echo (isset($_GET['order_page']) ? '&amp;order_page='.$_GET['order_page'] : ""); ?>"><b><?php _e('Price', 'ignitiondeck'); ?></b></a></th>
				<th scope="col" id="date" class="manage-column sortable desc"><a href="?page=order_details&amp;orderby=date&amp;sort=<?php echo $date_sort; ?><?php echo (isset($_GET['s']) ? '&amp;s='.$_GET['s'] : ""); ?><?php echo (isset($_GET['project']) ? '&amp;project='.$_GET['project'] : ""); ?><?php echo (isset($_GET['order_page']) ? '&amp;order_page='.$_GET['order_page'] : ""); ?>"><b><?php _e('Date', 'ignitiondeck'); ?></b></a></th>
			</tr>
		</thead>
		<?php
		if (count($items) > 0) {
			...
			for ($i=0; $i < count($item_array); $i++) {
				...
				<tr>
					<td colspan="6" alignt="left" class="orderoptions"><a href="?page=view_order&orderid=<?php echo $item_array[$i]->id ?>"><?php _e('View', 'ignitiondeck'); ?></a> | <a href="?page=edit_order&orderid=<?php echo $item_array[$i]->id ?>"><?php _e('Edit', 'ignitiondeck'); ?></a> | <a href="?page=delete_order&orderid=<?php echo $item_array[$i]->id ?>" class="delete" onclick="return confirm('<?php _e('Confirm Order Deletion', 'ignitiondeck'); ?> <?php echo $item_array[$i]->first_name." ".$item_array[$i]->last_name ?>?')"><?php _e('Delete', 'ignitiondeck'); ?></a></td>
				</tr>
				<?php
			}
		}
