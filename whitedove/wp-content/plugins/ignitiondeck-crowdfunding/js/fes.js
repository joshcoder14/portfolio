	...
	if (levelChange < 0) {
		...
		for (i = 1; i <= levelChange; i++) {
			...
			if (jQuery('#fes .form-level:hidden').length > 0) {
				...
				var last = jQuery('#fes .form-level').length;
				...
				jQuery(clone).find('label[for="project_level_1_title"]').attr('for', 'project_level_' + last + '_title');
				...
				jQuery(clone).find('label[for="project_level_1_price"]').attr('for', 'project_level_' + last + '_price');
				jQuery(clone).find('input.project_level_1_limit').attr('id', 'project_level_' + last + '_limit').removeClass().add('number-field');
				jQuery(clone).find('label[for="project_level_1_limit"]').attr('for', 'project_level_' + last + '_limit');
				...
				jQuery(clone).find('label[for="project_level_1_description"]').attr('for', 'project_level_' + last + '_description');
				...
				jQuery(clone).find('button.insert-media.add_media').attr('data-editor', 'project_level_' + last + '_long_description');
