	...
	*/
	...
	function widget($args, $instance) {
		if (!empty($instance)) {
			...
			echo '<div class="fh_widget fullwindow contentwide '.$custom_class.'" '.($height > 0 ? 'style="height: '.$height.'px;"' : '').' id="'.$id.'"><div class="fullwindow-internal cf '.$oddeven.'"><div class="constrained"><div class="ign-content-fullalt" style="height: '.$height.'px;"><div class="ign-text-container"><h3 class="widget-title">'.$title.'</h3>';
			echo '<div class="ign-content-text">'.$text.'</div></div></div></div></div></div>';
		}
	}
	/**
