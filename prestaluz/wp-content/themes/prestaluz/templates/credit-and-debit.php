        ...
        <div class="wrapper offer_wrapper">
            ...
            <div class="offers_list">    
                <div class="list_container">
                    <?php 
                        if( have_rows('mejores_tarjetas_de_credito_y_debito','options') ):
                            while( have_rows('mejores_tarjetas_de_credito_y_debito','options') ) : the_row();
                                    ...
                                    set_query_var('offers-2', $args);
                                    //Offers
                                    echo '<div class="offer_card fadeInUp">';
                                        get_template_part('templates/offers-list/offers-2');
                                    echo '</div>';
