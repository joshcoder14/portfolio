				...
				<div class="meta-box-sortables" style="min-height:0;">
					<div class="postbox">
						...
						<div id="product-settings-help" class="info inside" style="display: none;">
							...
							<p><strong><?php _e('Product Status', 'memberdeck'); ?></strong>: <?php _e('Active products show in default list. Archived products do not display but remain active. Disabled products neither display nor allow checkout.', 'memberdeck'); ?></p>
						...
						<div class="inside">
							...
							<p><a href="<?php echo menu_page_url('idc', false); ?>&amp;show_all_idc_products=<?php echo $product_filter_switch; ?>" onclick="" class="product_filter"><?php echo $product_filter_text; ?></a></p>
							<form method="POST" action="" id="idmember-settings" name="idmember-settings">
								<div class="columns" style="width: 49%; margin-right: 3%;">
									...
									<div class="form-input">
										<label for="product-status"><?php _e('Product Status', 'memberdeck'); ?></label>
										<select name="product-status" id="product-status">
											<option value="active"><?php _e('Active', 'memberdeck'); ?></option>
											<?php if (!is_idc_free()) { ?>
											<option value="archived"><?php _e('Archived', 'memberdeck'); ?></option>
											<option value="disabled"><?php _e('Disabled', 'memberdeck'); ?></option>
											<?php } ?>
										</select>
									</div>	
									<div class="form-input">
					...
					<div class="postbox">
						...
						<div class="inside">
							...
							if( $global_currency == 'BTC' ) {
								echo '<div id="btc-message" class="btc-message" style="background: #fff;box-shadow: 0 1px 1px rgba(0,0,0,.04);padding: 1px 12px;border-style:solid; border-color: #c3c4c7 #c3c4c7 #c3c4c7 #d63638; border-width: 1px 1px 1px 3px;font-size: 12px;font-weight: bold;text-align: center;">' . 
								__( 'Traditional/FIAT payment gateways such as PayPal and/or credit card processors will be unavailable with the Global Currency set to BTC' ) . 
								'</div>';	
								echo '<div id="btc-message" class="error">' . __( 'Traditional/FIAT payment gateways such as PayPal and/or credit card processors will be unavailable with the Global Currency set to BTC' ) . '</div>';	
							}
							?>
					...
					<div class="postbox">
						...
						<div id="dashboard-setup-help" class="info inside" style="display: none;">
							...
							<strong><?php _e('Dashboard Layout', 'memberdeck'); ?></strong>: <?php _e('When you select a Dashboard Layout, be aware of what sections remain visible in your chosen Layout. The Sections come into play with <em>Downloads</em>, when you assign your Downloads to Sections of the Dashboard.', 'memberdeck'); ?><br/><br/>
  							...
  							<?php } ?>
  							<a href="http://www.shareasale.com/shareasale.cfm?merchantID=46545" target="_blank"><?php _e('Become an affiliate', 'memberdeck'); ?></a> <?php /* xgettext:no-php-format */_e('to earn 25% commissions on all referrals', 'memberdeck'); ?>
  						</div>
						<div class="inside">
						...
						<div class="inside">
							<form method="POST" action="" id="idmember-dash" name="idmember-dash">
								...
								<div class="form-input">
									...
									<input type="text" name="co-name" id="co-name" value="<?php echo (isset($coname) ? apply_filters('idc_company_name', $coname) : ''); ?>"/>
								</div>
								<div class="form-input">
