jQuery(document).ready(function() {
	jQuery(document).on('idc_lightbox_level_select', function(e, clickLevel) {
	...
	jQuery(document).on('idc_lightbox_global', function(e, lbSource) {
	...
	jQuery('.idc_lightbox select[name="level_select"]').on('change',function(e) {
	...
	jQuery(document).on('idc_lightbox_general', function(e) {
