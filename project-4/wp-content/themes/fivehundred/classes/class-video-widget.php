	...
	*/
	...
	function widget($args, $instance) {
		if (!empty($instance)) {
			...
			echo '<div class="fh_widget"><div class="ign-video-headline ign-text-container"><h3 class="widget-title">'.$title.'</h3></div>';
			echo '<div class="ign-content-video">'.$embed.'</div></div>';
		}
	}
	/**
